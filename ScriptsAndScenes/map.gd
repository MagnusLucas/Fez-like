...
const PLAYER_SCENE = preload("res://ScriptsAndScenes/player.tscn")
const DOOR_SCENE = preload("res://ScriptsAndScenes/door.tscn")
const BASE_CELL_COLLIDER_SCENE = preload("res://ScriptsAndScenes/base_cell_collider.tscn")
